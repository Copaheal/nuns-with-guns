...
const BOOM_AUDIO = preload("uid://cxjtqxamdw1dw")
const BREAK_WOOD_AUDIO = preload("uid://gsvr4ucioitf")

const HIT_WOOD_LARGE = preload("uid://or36xkaokqsc")
const HIT_WOOD_MEDIUM = preload("uid://dqbarfx85qda8")
const HIT_WOOD_SMALL = preload("uid://tkpand1xng42")
